...
LANGUAGES = {
    ...
    "日本語": {
        ...
        "unknown": "該当情報は確認できませんでした。詳細はカスタマーサポート(041-584-8820)までお問い合わせください。",
    },
    "中文": {
    ...
    "Español": {
        ...
        "unknown": "No se encontró la información solicitada. Contacte al soporte al cliente al 041-584-8820.",
    },
    "Français": {
        ...
        "unknown": "L'information demandée n'a pas été trouvée. Veuillez contacter le support client au 041-584-8820.",
    },
    "Deutsch": {
        ...
        "unknown": "Die angeforderten Informationen wurden nicht gefunden. Bitte kontaktieren Sie den Kundensupport unter 041-584-8820.",
    },
    "Português": {
        ...
        "unknown": "A informação solicitada não foi encontrada. Entre em contato com o suporte ao cliente pelo 041-584-8820.",
    },
    "Tiếng Việt": {
        ...
        "unknown": "Không tìm thấy thông tin yêu cầu. Vui lòng liên hệ hỗ trợ khách hàng theo số 041-584-8820.",
    },
    "ภาษาไทย": {
        ...
        "unknown": "ไม่พบข้อมูลที่ร้องขอ กรุณาติดต่อฝ่ายสนับสนุนลูกค้าที่ 041-584-8820",
    },
    "Bahasa Indonesia": {
        ...
        "unknown": "Informasi yang diminta tidak ditemukan. Silakan hubungi dukungan pelanggan di 041-584-8820.",
    },
    "العربية": {
        ...
        "unknown": "لم يتم العثور على المعلومات المطلوبة. يرجى الاتصال بدعم العملاء على الرقم 041-584-8820.",
    },
    "Русский": {
        ...
        "unknown": "Запрашиваемая информация не найдена. Свяжитесь со службой поддержки клиентов по номеру 041-584-8820.",
    },
}
...
def stream_answer(openai_client, question, context_docs, lang="한국어", chat_history=None, product="", model="gpt-5.4-mini"):
    ...
    common_rules = (
        ...
        "Ambiguity handling:\n"
        "- For any ambiguous user question, do not guess or force a speculative answer.\n"
        "- If multiple interpretations or answers are possible, ask 1 to 3 short clarifying questions first.\n"
        "- Ask only the minimum questions needed to answer correctly, and ask them in the selected response language.\n"
        "- If the user provided enough context, answer directly using the provided documents.\n"
        "- If a safe partial answer is useful, clearly state the assumption before answering and ask what detail is needed to confirm.\n"
        "- When the answer depends on product, model, site condition, wiring, menu setting, sensor type, installation type, output/relay behavior, calibration state, measurement symptom, audience, or purpose, and that detail is missing, ask first.\n\n"
        "Rules:\n"
