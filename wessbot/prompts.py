...
def build_system_prompt(
    ...
    *,
    ...
    answer_shape = (
        ...
        "- For ENV120 waveform screens, the upper-left value is Empty plus measurement range, not the live measurement value; never explain it as the measured sludge level/distance.\n"
